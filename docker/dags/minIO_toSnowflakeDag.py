...
# -------- Python Callables --------
#download the data from minio to local directory
...
def load_to_snowflake(**kwargs):
    ...
    Load parquet files from local directory into Snowflake tables.
    connects to Snowflake, uploads files to stage, and executes COPY INTO commands.
    """
